<?php
	...
	/* LOAD DEPENDECIES */
	require_once('presenters/about.class.php');

	/**
	 * About Class which contains the about us information.
	 */
	class About extends BaseModel
	{
		...
		public function get()
		{
			return new \Presenters\About($this);
		}
